...
Now we plot everything together. We plot the outline polygon twice, once filled without line at the bottom and once without fill but with line at the top, to create a crips outline for our world map.
